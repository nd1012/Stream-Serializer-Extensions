...
{
    /// <summary>
    /// Base class for a stream serializing value object type
    /// </summary>
    /// <typeparam name="T">Final type</typeparam>
    public abstract class StreamSerializerValueBase<T> : ValueObjectBase<T>, IObjectValidatable, IStreamSerializerVersion where T : StreamSerializerValueBase<T>
    {
        /// <summary>
        /// Base object version
        /// </summary>
        ...
        protected StreamSerializerValueBase(int? objectVersion = null) : base()
        ...
        /// <param name="objectVersion">Object version</param>
        protected StreamSerializerValueBase(IDeserializationContext context, int? objectVersion = null) : base()
        {
        ...
        /// <inheritdoc/>
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext) => ValidatableObjectBase.ObjectValidatable(this);
    }
}
