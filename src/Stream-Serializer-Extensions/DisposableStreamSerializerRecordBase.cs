...
namespace wan24.StreamSerializerExtensions
{
    ...
    /// </summary>
    public abstract record class DisposableStreamSerializerRecordBase : DisposableRecordBase, IStreamSerializerVersion, IObjectValidatable
    {
        /// <summary>
        /// Base object version
        /// </summary>
        ...
        protected DisposableStreamSerializerRecordBase(int? objectVersion = null) : base()
            => _ObjectVersion = objectVersion ?? GetType().GetCustomAttribute<StreamSerializerAttribute>()?.Version;
        ...
        /// <param name="objectVersion">Object version</param>
        protected DisposableStreamSerializerRecordBase(Stream stream, int version, int? objectVersion = null) : base()
        {
        ...
        /// </summary>
        protected int? SerializedObjectVersion => IfUndisposed(_SerializedObjectVersion);

        /// <summary>
        /// Serializer version (if <see langword="null"/>, the instance wasn't deserialized)
        /// </summary>
        protected int? SerializerVersion => IfUndisposed(_SerializerVersion);
