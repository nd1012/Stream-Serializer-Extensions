...
namespace wan24.StreamSerializerExtensions
{
    ...
    /// </summary>
    public abstract record class StreamSerializerRecordBase : ValidatableRecordBase, IStreamSerializerVersion
    {
        /// <summary>
        /// Base object version
        /// </summary>
        ...
        protected StreamSerializerRecordBase(int? objectVersion = null) : base() => _ObjectVersion = objectVersion ?? GetType().GetCustomAttribute<StreamSerializerAttribute>()?.Version;
        ...
        /// <param name="objectVersion">Object version</param>
        protected StreamSerializerRecordBase(Stream stream, int version, int? objectVersion = null) : base()
        {
